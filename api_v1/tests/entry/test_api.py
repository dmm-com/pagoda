...
class APITest(AironeViewTest):
    ...
    def test_search_chain(self):
        ...
        entity_vlan = self.create_entity(
            user,
            "VLAN",
            attrs=[
        ...
        entity_network = self.create_entity(
            user,
            "Network",
            attrs=[
        ...
        entity_ipv4 = self.create_entity(
            user,
            "IPv4 Address",
            attrs=[
