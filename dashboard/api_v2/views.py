...
class AdvancedSearchSQLAPI(ReadOnlyModelViewSet):
    ...
    def get_serializer_class(self):
        # sg_model : LBServiceGroupModel
        sg_model = UserModel.create_model_from_entity(
            Entity.objects.get(name="LBServiceGroup", is_active=True)
        )

        # lb_model : LB
        # TODO: This class is generated by sg_model context
        lb_model = UserModel.create_model_from_entity(Entity.objects.get(name="LB", is_active=True))

        # lb_service_group_field = LBPolicyTemplate._meta.get_field("lb_service_group")
        # lb_service_group_field.remote_field.model

        serializer_class = DRFGenerator.serializer.create(sg_model, {"id": None, "name": None})
