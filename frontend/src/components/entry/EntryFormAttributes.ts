...
import { EntryRetrieveValueAsObjectSchema } from "../../apiclient/autogenerated/models/EntryRetrieveValueAsObjectSchema";
import { DjangoContext } from "../../utils/DjangoContext";

type WithChecked = { checked: boolean };
type EntryFormAttributeValueAsObject = EntryRetrieveValueAsObject & WithChecked;
type EntryFormAttributeValueAsGroup = EntryRetrieveValueAsObjectSchema &
  WithChecked;
