...
export function EditAttributeValue({ attrName, attrInfo, handleChangeAttribute }) {
  ...
  switch (attrInfo.type) {
    ...
    case djangoContext.attrTypeValue.date:
      return <ElemString attrValue={attrInfo.value} handleChange={handleChangeAttribute}/>;
