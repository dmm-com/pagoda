...
import { EntityList as EntityListInterface } from "@dmm-com/airone-apiclient-typescript-fetch/src/autogenerated/models/EntityList";
...
describe("EntityList", () => {
  const entities: EntityListInterface[] = [
    {
      id: 1,
      name: "entity1",
      note: "entity1",
