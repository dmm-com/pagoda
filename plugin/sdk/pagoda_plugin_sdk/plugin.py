...
class Plugin:
    ...
    def enable(self):
        ...
        Note:
            Default implementation calls activate().
            Subclasses can override this method for custom enable logic.
        """
        self.activate()
    ...
    def disable(self):
        ...
        Note:
            Default implementation calls deactivate().
            Subclasses can override this method for custom disable logic.
        """
        self.deactivate()
