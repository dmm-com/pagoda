...
class Job(models.Model):
    ...
    @classmethod
    def new_create(
        kls, user: User, target: Entry, text: str = "", params: dict[str, Any] = {}
    ) -> "Job":
    ...
    @classmethod
    def new_import(
        kls, user: User, entity: Entity, text: str = "", params: dict[str, Any] = {}
    ) -> "Job":
        return kls._create_new_job(
            user=user,
            target=entity,
    ...
    @classmethod
    def new_export(
        kls, user: User, target: ACLBase | None = None, text: str = "", params: dict[str, Any] = {}
    ) -> "Job":
        return kls._create_new_job(
            user=user,
            target=target,
    ...
    def new_create_entity(
        kls, user: User, target: Entity, text: str = "", params: dict[str, Any] = {}
    ) -> "Job":
        return kls._create_new_job(
            user=user,
            target=target,
    ...
    def new_update_documents(
        kls, target: ACLBase | None, text: str = "", params: dict[str, Any] = {}
    ) -> "Job":
    ...
    def new_create_entry_v2(
        kls, user: User, target: Entry | None, text: str = "", params: dict[str, Any] = {}
    ) -> "Job":
        return kls._create_new_job(
            user=user,
            target=target,
    ...
    def new_bulk_edit_entry_v2(
        kls, user: User, target: Entity, params: dict[str, Any] = {}
    ) -> "Job":
        return kls._create_new_job(
